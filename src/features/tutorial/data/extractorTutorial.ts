// src/features/tutorial/data/extractorTutorial.ts

import type { TutorialDefinition } from "../types";

export const extractorTutorial: TutorialDefinition = {
  id: 'extractor-tour',
  ...
  steps: [
    ...
    },
    {
      ...
      content: {
        es: "Puedes abrir el extractor en cualquier momento desde el menú de herramientas de la barra de navegación.",
        eu: "Nahi duzunean ireki dezakezu datu-erauzlea nabigazio-barrako tresnen menutik."
      },
    ...
    },
    {
      ...
      onEnterAction: [
        ...
        { type: 'TOGGLE_MODAL', payload: { modalId: 'data-extractor', stackPrevious: true } },
